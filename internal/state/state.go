...
type Record struct {
	...
	PreviousPaths    []string   `json:"previous_paths,omitempty"` // diagnostic-only former active checkouts
	RemoteStatus     string     `json:"remote_status,omitempty"`  // last confirmed "gone", not inferred offline
