---
code:
id: I_kwDOE2M9Zc5JdBjw
databaseId: 1232345328
number: 30
url: https://github.com/octomation/maintainer/issues/30
title: "org: prepare release v0.1.0"
labels:
  - "scope: docs"
  - "type: improvement"
  - "impact: high"
...
# org: prepare release v0.1.0

Prepare a stable v0.1.0 release covering the main GitHub Contributions Calendar scenarios. For a user the release should be a clear installation point: viewing the calendar, choosing a date, storing a snapshot, comparing and the histogram all work consistently.
...
- https://github.com/golang/tools/releases/tag/gopls/v0.8.4
- https://github.com/gohugoio/hugo/releases/tag/v0.99.0
