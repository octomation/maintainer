...
updatedAt: 2023-03-25T20:26:24Z
lastEditedAt:
...
**Current state:** the issue is closed. For an explicit anchor on HEAD there is `git/+5`, and a timestamp can be passed directly ([#76](issue-76.md)). Verification has to pin both the input date and the history, rather than declaring any choice in November wrong. The related case of a choice before a specific date is [#119](issue-119.md).
